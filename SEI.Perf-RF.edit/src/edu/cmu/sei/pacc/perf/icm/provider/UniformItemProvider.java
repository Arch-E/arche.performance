...
/**
 * This is the item provider adapter for a {@link edu.cmu.sei.pacc.perf.icm.Uniform} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource		
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Uniform_max_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Uniform_max_feature", "_UI_Uniform_type"),
         IcmPackage.Literals.UNIFORM__MAX,
         true,
         false,
         false,
  ...
  protected void addMinPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Uniform_min_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Uniform_min_feature", "_UI_Uniform_type"),
         IcmPackage.Literals.UNIFORM__MIN,
         true,
         false,
         false,
         ItemPropertyDescriptor.REAL_VALUE_IMAGE,
  ...
  public String getText(Object object)
  {
    ...
    return getString("_UI_Uniform_type") + " " + uniform.getMax();
  }
