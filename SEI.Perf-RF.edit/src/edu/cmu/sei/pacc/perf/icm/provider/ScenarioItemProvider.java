...
/**
 * This is the item provider adapter for a {@link edu.cmu.sei.pacc.perf.icm.Scenario} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource		
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         IcmPackage.Literals.SCENARIO__NAME,
         true,
         false,
         false,
  ...
  protected void addNumberPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Scenario_number_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Scenario_number_feature", "_UI_Scenario_type"),
         IcmPackage.Literals.SCENARIO__NUMBER,
         true,
         false,
         false,
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    {
      case IcmPackage.SCENARIO__NAME:
      case IcmPackage.SCENARIO__NUMBER:
