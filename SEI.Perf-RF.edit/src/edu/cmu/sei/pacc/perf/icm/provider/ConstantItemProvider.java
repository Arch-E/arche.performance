...
/**
 * This is the item provider adapter for a {@link edu.cmu.sei.pacc.perf.icm.Constant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         IcmPackage.Literals.CONSTANT__VALUE,
         true,
         false,
         false,
  ...
  protected void addOffsetPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Constant_offset_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Constant_offset_feature", "_UI_Constant_type"),
         IcmPackage.Literals.CONSTANT__OFFSET,
         true,
         false,
         false,
         ItemPropertyDescriptor.REAL_VALUE_IMAGE,
